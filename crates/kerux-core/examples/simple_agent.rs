//! Simple Kerux example
//!
//! This example demonstrates basic usage of the kerux-core library.

use std::time::Duration;

use async_trait::async_trait;
use kerux_core::{
    agent::{AgentConfig, KeruxAgent},
    client::{ClientConfig, OpenAIClient},
    error::Result,
    schema::ToolSchema,
    tools::{KeruxTool, ToolContext, ToolRegistry, ToolResult},
};
...
async fn main() -> Result<()> {
    ...
    println!("Kerux Simple Agent Example\n");
    println!("This example demonstrates how to use the kerux-core library.\n");
