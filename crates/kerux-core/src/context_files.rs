...
//!
//! This mirrors the upstream Kerux context-file behavior at a smaller scope:
...
/// Load all `.md` and `.txt` files from a Kerux context directory.
...
/// Load context files from `~/.config/kerux/context` when available.
